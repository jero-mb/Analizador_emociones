...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    button:hover { transform: translateY(-2px); box-shadow: 0 10px 25px rgba(37,99,235,0.3); background: #1d4ed8; }
    ...
    .value { font-size: 20px; font-weight: 700; color: var(--text); }
    .progress {
    ...
    .chip:hover { border-color: var(--accent); background: #eff6ff; transform: translateY(-1px); }
    .error {
      background: #fee2e2;
